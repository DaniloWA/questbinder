...
import { PermissionSet, SessionPermissions, User, SessionLogConfig } from '../../types';
import { Button } from '../ui/Button';
import { 
    Shield, MousePointer2, DoorOpen, PenTool, Dices, Save, 
    CloudFog, RadioTower, User as UserIcon, Globe, ChevronRight, Check, 
    Plus, Trash2, Edit, Ruler, Lock, Eye, EyeOff, ScrollText, Share2, ScanEye, Book, FileText, Sword, Zap, Eraser
} from 'lucide-react';
...
export const PermissionsModal: React.FC<PermissionsModalProps> = ({ isOpen, onClose, permissions, onUpdate }) => {
