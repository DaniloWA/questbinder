...
export const TokenEditModal: React.FC<TokenEditModalProps> = ({ token, initialPosition, players, availableCharacters = [], onSave, onSaveTemplate, onCancel }) => {
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); onSave(getData(), initialPosition); }} className="flex flex-col h-[650px]">
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-0 overflow-hidden bg-zinc-950">
            <div className="w-full md:w-5/12 bg-zinc-950 p-6 border-b md:border-b-0 md:border-r border-zinc-800 flex flex-col gap-6 overflow-y-auto custom-scrollbar">
                <div className="w-full aspect-square bg-zinc-900/50 rounded-xl border-2 border-dashed border-zinc-800 relative group overflow-hidden flex items-center justify-center shrink-0">
                    ...
                    {activeTab === 'stats' && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 max-h-64 overflow-y-auto custom-scrollbar p-1">
