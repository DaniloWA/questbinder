...
import {
  CursorDefault, CursorHand, CursorSword, CursorTarget, CursorWand, CursorPaw,
  CursorSkull, CursorGem, CursorQuill, CursorEye, CursorGhost, CursorHeart,
  CursorShield, CursorPotion, CursorLightning, CursorStar, CursorAxe, CursorCrown
} from '../cursors';

export interface CursorShape {
  id: string;
  label: string;
  path: string; // SVG Path 'd' attribute (fallback)
  Component?: React.FC<{ color?: string; size?: number; className?: string; }>;
  imageUrl?: string; // Legacy: Full SVG/Image URL
...
export const CURSOR_SHAPES: CursorShape[] = [
  ...
  },
  {
    ...
    Component: CursorHand,
    hotspot: { x: 9, y: 2 }
  },
  {
    id: 'sword',
    label: 'Espada',
    path: 'M12 2L10 14H12L10 16H14L12 14H14L12 2ZM9 16V17H15V16H9ZM10 17V21H14V17H10ZM11 21V23H13V21H11Z',
    Component: CursorSword,
    hotspot: { x: 12, y: 2 }
  },
  {
    id: 'target',
  ...
  },
  {
    id: 'wand',
    label: 'Varinha',
    path: 'M7.5 5.6L10 7 8.6 4.5 10 2 7.5 3.4 5 2l1.4 2.5L5 7zm12 9.8L17 14l1.4 2.5L17 19l2.5-1.4L22 19l-1.4-2.5L22 14zM22 2l-9.5 9.5L14 13l1.5 1.5L22 8V2z',
    Component: CursorWand,
    hotspot: { x: 7.5, y: 5.6 }
  },
  {
    id: 'paw',
  ...
  },
  {
    id: 'quill',
    label: 'Pena',
    path: 'M4 21l1-6 13-13c1-1 3-1 4 0s1 3 0 4L9 19l-5 2z',
    Component: CursorQuill,
    hotspot: { x: 4, y: 21 }
  },
  {
    id: 'eye',
