...
import { AccessGate, FeatureGate } from '../AccessGate';
...
export const AttackZonePanel: React.FC<AttackZonePanelProps> = ({
  ...
  return (
    <FeatureGate feature="attackZones" mode="hide">
            ...
            <div className="md:w-2/3 border-b md:border-b-0 md:border-r border-zinc-700 flex flex-col min-h-0">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2">
                {filteredTemplates.map((template) => {
                  ...
                  return (
                    <AccessGate key={template.id} requirePermission="attackZoneUse" mode="disable">
                      <button
                ...
                {/* Custom Zone Button */}
                <AccessGate requirePermission="attackZoneCreate" mode="disable">
                  <button
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <AccessGate requirePermission="attackZoneUse" mode="disable">
                            <button
