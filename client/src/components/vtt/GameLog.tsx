...
import { Send, Dices, MapPin, User, Sword, Zap, Backpack, ThumbsUp, ThumbsDown, ChevronDown, MessageSquare, ExternalLink, Maximize2, Minimize2, Move, GripHorizontal, ArrowRightToLine, EyeOff, Hash, Heart, ShieldAlert, Footprints, Activity, Filter, BookOpen, Skull } from 'lucide-react';
...
export const GameLog: React.FC<GameLogProps> = ({ onModeChange }) => {
  ...
  const filteredMessages = chatMessages.filter(msg => {
      ...
      // Private messages (future feature) could be checked here too
