...
export const SceneNavigation: React.FC = () => {
    ...
    const handleDelete = (e: React.MouseEvent, id: string) => {
        ...
        openModal(
            <div className="space-y-4">
                <p>Tem certeza que deseja excluir esta camada? Todos os tokens e configurações nela serão perdidos permanentemente.</p>
                <div className="flex justify-end gap-2 mt-4">
                    <Button variant="ghost" onClick={closeModal}>Cancelar</Button>
                    <Button variant="destructive" onClick={() => {
                        deleteScene(id);
                        closeModal();
                    }}>Excluir Camada</Button>
                </div>
            </div>,
            { title: 'Excluir Camada', variant: 'alert' }
        );
    };
    ...
    return (
        <div className="absolute bottom-6 left-6 z-30 flex flex-col items-start gap-2">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[10px] opacity-50">{scene.tokens.length} tokens</p>
                                </div>
            ...
            {/* Toggle Button */}
            <Tooltip content="Gerenciar Cenas/Andares" position="right">
                <button 
