...
export default {
  ...
  vtt: {
    ...
    grid: {
      inspector: {
        title: 'Inspetor de Grid',
        cellSize: 'Tamanho da Célula',
        cellSizeUnit: 'px',
        offset: 'Deslocamento do Grid',
        ...
        autoDetect: 'Auto Detectar Grid',
        detecting: 'Detectando...',
        confidence: 'Confiança',
        snapValues: 'Ajustar Valores',
        lockRatio: 'Travar Proporção',
        threePointAlign: 'Alinhar 3 Pontos',
        dragManually: 'Arrastar Grid Manualmente',
        stopDragging: 'Parar de Arrastar',
        draggingActive: 'Arrastando Ativo',
        resetDefaults: 'Restaurar Padrões',
        keyboardHint: 'Use Setas para ajustar • Segure Shift para 10px',
        threePointHint: 'Clique 3 Pontos: Superior-Esquerdo, Superior-Direito, Inferior-Esquerdo',
        simpleView: 'Visão Simples',
        advancedView: 'Visão Avançada',
        options: 'Opções',
        recentDetections: 'Detecções Recentes',
        presets: 'Presets',
        readyToAlign: 'Pronto para alinhar',
      },
    },
    tools: {
      toolbar: {
